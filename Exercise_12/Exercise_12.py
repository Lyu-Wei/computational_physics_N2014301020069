    ...
    for i in range(L):    
        for j in range(L):
            if i==0 or j==0 or i==L-1 or j==L-1:
                pass
            elif int(L*(35/101))<=i<=int(L*(65/101)) and j==int(L*(35/101)):
                pass
            elif int(L*(35/101))<=i<=int(L*(65/101)) and j==int(L*(65/101)):
                pass
            else:
...
plt.plot(l,N,'g.-',label='Jacobi')
plt.plot(ll,NN,'y.-',label='SOR')
plt.legend(loc='upper left')
plt.grid(True)
plt.xlabel('L(m)')
plt.ylabel(r'$N_{ite}$')
plt.title(r'$N_{ite}$ versus L')
plt.show()