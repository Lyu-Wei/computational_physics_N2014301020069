...
plt.plot(x1,d1,label='t=0',c='k')
#plt.plot(x2,d2,label='t=10',c='k')
#plt.plot(x3,d3,label='t=100',c='k')
plt.scatter(x1,d1,s=10,c='k')
#plt.scatter(x2,d2,s=10,c='k')
#plt.scatter(x3,d3,s=10,c='k')
